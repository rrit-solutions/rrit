...
/**
 * Raghava Ram IT Solutions — single-page site.
 *
 * This is the standalone demo ported to the App Router one-for-one: the markup,
 * the class names and the section order are unchanged. Styles live in
 * app/globals.css, the three inline <script> blocks live in SiteScripts (they
 * touch the DOM, so they have to run on the client).
 */
export default function Home() {
  return (
    <>
      <nav className="nav">
        {/* next/image, not <img>: the source is a 1254px, 627 KB PNG being
            shown at 44px. Next serves a resized, modern-format copy instead,
            which is the single biggest weight saving on the page. `priority`
            because it is above the fold and would otherwise be lazy-loaded. */}
        <Image
          className="logo"
          src="/image.png"
      ...
      {/* Landmark: nav and footer sit outside it, everything a reader came
          for sits inside. Purely semantic — <main> is display:block and no
          rule in globals.css selects on body's children. */}
      <main>
      <section className="hero">
        ...
        <div className="hero-visual reveal">
          <div className="system-visual">
            ...
            <svg className="system-lines" viewBox="0 0 620 470" aria-hidden="true">
              <path className="line l1" d="M110 105 C190 135 225 185 305 230" />
              <path className="line l2" d="M510 105 C430 135 395 185 315 230" />
              <path className="line l3" d="M105 365 C190 335 230 285 305 245" />
              <path className="line l4" d="M515 365 C430 335 390 285 315 245" />
      ...
      <section className="section" id="services">
        ...
        <div className="services-wrap reveal">
          ...
          <div className="service-hint">
            <span>‹</span> move through solutions <span>›</span>
          </div>
        </div>
      </section>
      ...
      <section className="section dark" id="solutions">
        ...
        <div className="solutions reveal professional-solutions">
          <article className="solution professional-solution">
            ...
            <p>Customers wait for replies and valuable leads can be missed.</p>
          ...
          <article className="solution professional-solution">
            <div className="solution-top">
              <span className="challenge-icon">
                <svg viewBox="0 0 48 48" aria-hidden="true">
                  <rect x="8" y="9" width="32" height="30" rx="4" fill="none" />
                  <path d="M15 17h18M15 24h13M15 31h8M34 29l5 5-5 5" fill="none" />
                </svg>
              </span>
            ...
            <p>Repetitive tasks consume time and increase the chance of errors.</p>
            <div className="solution-flow">
              <span className="flow-line"></span>
              <span className="flow-arrow">↓</span>
            </div>
      ...
      <section className="section projects-section" id="projects">
        ...
        <div className="project-grid reveal">
          <article className="project-card featured-project">
            ...
            <p>
              Campaign setup, audience targeting and performance-focused digital
              advertising.
            </p>
      ...
      <section className="cta" id="contact">
        ...
        <div className="mountain" aria-label="Digital growth journey">
          <svg viewBox="0 0 520 280" role="img" aria-hidden="true">
            ...
            {/* destination flag */}
            <path d="M472 35V5" stroke="#173b68" strokeWidth="5" strokeLinecap="round" />
